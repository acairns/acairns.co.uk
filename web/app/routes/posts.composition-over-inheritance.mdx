...
<Post title={frontmatter.meta[0].title}>
    ...
    <div className='sm:float-right !-mt-4 !-mb-8'>
    ...
    <div style={{
        ...
        <video autoPlay muted loop>
            <source src="/003/003-baseclass.mp4" type="video/mp4" />
        </video>
    </div>
