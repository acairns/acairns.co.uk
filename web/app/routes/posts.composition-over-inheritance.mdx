...
meta:
  ...
  - property: 'og:image'
    name: 'og:image'
    content: 'https://acairns.co.uk/003/og-image.png'
  ...
  - name: 'og:url'
    property: 'og:url'
    content: 'https://acairns.co.uk/posts/composition-over-inheritance'
  - name: 'og:title'
    property: 'og:title'
    content: Composition over Inheritance
  - name: 'og:description'
...
<Post title={frontmatter.meta[0].title}>
    ...
    Instead of using Inheritance to reuse code, we can use _Dependency Injection_ and utilise Composition instead. We also spoke about _Single Responsibility_ earlier, too.
